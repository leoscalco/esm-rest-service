    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('empty', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='intervention_section.EmptyIntervention')),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('media', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='intervention_section.MediaIntervention')),
            ],
            bases=('result_section.result',),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('question', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='intervention_section.QuestionIntervention')),
            ],
            bases=('result_section.result',),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('result_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='result_section.Result')),
                ('urlForDataFile', models.URLField()),
                ('task', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='intervention_section.TaskIntervention')),
            ],
            bases=('result_section.result',),
        ),
        migrations.AddField(
